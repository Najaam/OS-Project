...
function TransParentInputs({ placeholder, width = "", height = "", id="default", label ="" ,fontSize = "16px"}) {
    ...
    const inputVariants = {
        ...
        rest: {
            ...
            background: "linear-gradient(120,rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0))"
        },
    };
...
>
    {label}
            ...
            <motion.input
                ...
                className="px-2 py-2 rounded-lg border border-gray-300 bg-transparent text-white focus:outline-none"
